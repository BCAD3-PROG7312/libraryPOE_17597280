...
namespace libraryPOE_17597280
{
    public partial class ReplaceBooks : Form
    {
        ...
        {
            GetSelectedvaluesfromCombobox(cb1, cb2, cb3, cb4, cb5, cb6, cb7, cb8, cb9, cb10);
        ...
        private void createList()
        {
            ...
            CallNum1.Text = callnumber1;
            CallNum2.Text = callnumber2;
            CallNum3.Text = callnumber3;
            CallNum4.Text = callnumber4;
            CallNum5.Text = callnumber5;
            CallNum6.Text = callnumber6;
            CallNum7.Text = callnumber7;
            CallNum8.Text = callnumber8;
            CallNum9.Text = callnumber9;
            CallNum10.Text = callnumber10;
        }
